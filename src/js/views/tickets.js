    ...
    <div class="col s12 m6">
      <div class="card ticket-card">
        ...
        <div class="ticket-time-price d-flex align-items-center">
          <div class="ticket-time d-flex ">
            <span class="ticket-time-departure">Вылет: ${ticket.departure_at}</span>
            <span class="ticket-time-return">Обратный вылет: ${ticket.return_at}</span>
          </div>
        ...
        <button class="waves-effect waves-light btn-small green darken-1 add-favorite ml-auto" id="favorite">Add to favorites</button>
      </div>
    </div>
    `;
  }
